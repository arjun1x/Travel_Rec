...
const questions: [string, ReactNode][] = [
  ...
  ['Where do the photographs come from?', <>Destination photos are by Wikimedia Commons and Wikipedia contributors, used under their open licenses and resized for the web; the hero and collection images are bundled editorial photographs. Every author and license is listed in the <a href="/images/CREDITS.md">photo credits</a>.</>],
]
